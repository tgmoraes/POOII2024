...
public class TesteFuncional {
	...
	private static <T> T func2(BinaryOperator<T> func, T op1, T op2) {
		return (T) func.apply(op1, op2);
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(func( (a, b) -> a+b, 9,89));
		
		System.out.println(func2( (a, b) -> a+b, 9,89));
